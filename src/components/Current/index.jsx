...
return (
  <> 
      <div className={Math.round(weather.main.temp) < 10 ? "weather__current weather__current--cold" : "weather__current"}>
        ...
        <div className="weather__inner">
          <div className="weather__section">
            ...
            <div className="weather__value">
              <span id="sunrise">{time(weather.sys.sunrise)
              }</span>
            </div>
          </div>
          <div className="weather__section">
            ...
            <div className="weather__value">
              <span id="sunset">{time(weather.sys.sunset)
              }</span>
            </div>
          </div>
        </div>
